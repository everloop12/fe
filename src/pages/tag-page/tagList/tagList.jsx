...
function TagListHead({ order, orderBy, setOrder, setOrderBy, handleDelete }) {
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <TagListHead order={order} orderBy={orderBy} setOrder={setOrder} setOrderBy={setOrderBy} selected={selected} handleDelete={handleDelete} />
          <TableBody>
            {data.map((tag, index) => {
